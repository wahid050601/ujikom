...
<script>
    $(document).ready(function(){
        ...
        $('#table-katg').on('click', '#btnKatg', function(){
            ...
            // Load function
            // loadJenisPembayaran(kategoriPem);
            // $.ajax({
            //     method: "POST",
            //     url: "pages/adm-katg/adm-katg-load.php",
            //     dataType: "json",
            ...
            //     },
            //     success: function(msg){
            //         $('.header-pem').html(kategoriPem);
            //         $('.button-spp').append('<button id="bntaddpem" data-katg="'+kategoriPem+'" class="btn label btn-primary"><i class="fas fa-plus"></i></button>');
            //         if(kategoriPem == 'ujian' || kategoriPem == 'kegiatan'){
            //             $('.button-spp').append('<button id="bntdellpem" data-katg="'+kategoriPem+'" class="btn label btn-primary" style="display: none;"><i class="fas fa-trash"></i></button>');
            //         }else{
            //             $('.button-spp').append('<button id="bntdellpem" data-katg="'+kategoriPem+'" class="btn label btn-primary"><i class="fas fa-trash"></i></button>');
            //         }
            ...
            //                     <tr>
            //                         <td>`+val.num+`</td>`;
            //                         if(kategoriPem == 'ujian'){
            //                             datapem += `<td>`+button+` `+val.pem+`</td>`;
            //                         }else if(kategoriPem == 'kegiatan'){
    ...
    // FUNCTION LOAD MASTER DATA PEMBAYARAN
    // function loadJenisPembayaran(idKategori){
    //     $.ajax({
    //         method: "POST",
    //         url: "pages/adm-katg/adm-katg-load.php",
    //         dataType: "json",
    ...
    //         },
    //         success: function(msg){
    //             $('.header-pem').html(idKategori);
    //             $('.button-spp').append('<button id="bntaddpem" data-katg="'+idKategori+'" class="btn label btn-primary"><i class="fas fa-plus"></i></button>');
    //             if(idKategori == 'ujian' || idKategori == 'kegiatan'){
    //                 $('.button-spp').append('<button id="bntdellpem" data-katg="'+idKategori+'" class="btn label btn-primary" style="display: none;"><i class="fas fa-trash"></i></button>');
    //             }else{
    //                 $('.button-spp').append('<button id="bntdellpem" data-katg="'+idKategori+'" class="btn label btn-primary"><i class="fas fa-trash"></i></button>');
    //             }
    ...
    //             //     console.log($("#formAddPemSpp").serialize());
    //             //     // var dataJson = {
    //             //     //     bulan : $('#bulan-spp').val(),
    ...
    //                 AddPembayaranUjian(nom_umum, nom_tkj, nom_akl, nom_bdp);
    ...
    //                 e.preventDefault();
    //                 AddPembayaranKegiatan($('#formAddKegiatan').serialize());
    ...
    //                     }).then((result) => {
    //                         if(result.isConfirmed){
    //                             DeletePembayaranKegiatan(idkegiatan);
