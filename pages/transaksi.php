<?php
    ...
    $data_transaksi = getPelanggan($query);
                        ...
                        <div class="row mr-1">
                                ...
                                <table class="table table-bordered table-hover table-sm">
                                    <thead class="bg-success text-white">
                                        <tr class="text-center">
                                            <th scope="coll">No.</th>
                                            <th scope="coll">Tanggal Transaksi</th>
                                            <th scope="coll">Nama Pelanggan</th>
                                            <th scope="coll">Harga</th>
                                            <th scope="coll">Berat</th>
                                            <th scope="coll">Tanggal Selesai</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $dt["transaksi_tanggal"]; ?></td>
                                            <td><?= $dt["transaksi_pelanggan"]; ?></td>
                                            <td><?= $dt["transaksi_harga"]; ?></td>
                                            <td><?= $dt["transaksi_berat"]; ?></td>
                                            <td><?= $dt["transaksi_tglselesai"]; ?></td>
                                            <td><?= $dt["transaksi_status"]; ?></td>
                            ...
                            <!-- <div class="col-lg-3 bg-white">
                                <div class="head-form text-center mt-2">
                                    <span><i class="fas fa-user-plus"></i> Tambah Data Transaksi</span>
                                    <hr>
                                </div>
